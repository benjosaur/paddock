...
function buildSystemPrompt(
  ...
  return [
    ...
    "- Settings page: tab.* targets switch tabs. To stage a new dropdown option, ui_type the value into option-input.<list> (services, localities or trainingRecordTypes) then ui_click option-add.<list>; option-toggle.<list>.<value> archives or restores an existing option. All of these only stage a draft — the user must press Save to apply it.",
