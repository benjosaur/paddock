...
export const rolePermissions: Record<UserRole, RolePermissions> = {
  ...
  Coordinator: {
    ...
    packages: { read: true, create: true, update: true, delete: false },
    mag: { read: true, create: true, update: true, delete: false },
    requests: { read: true, create: true, update: true, delete: false },
    trainingRecords: {
      read: true,
      create: false,
      update: false,
