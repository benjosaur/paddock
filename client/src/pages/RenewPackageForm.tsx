    ...
    <div className="space-y-6 animate-in">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
          Renew Care Confirmed
        </h1>
      </div>

      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {renderFormSection("Current Care Confirmed (Ending)", oldPackageData, true)}
          {renderFormSection("New Care Confirmed", newPackageData, false)}
        </div>
        ...
        <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
          ...
          <Button type="submit" disabled={renewPackageMutation.isPending}>
            {renewPackageMutation.isPending ? "Renewing..." : "Renew Care Confirmed"}
          </Button>
        </div>
      </form>
    </div>
